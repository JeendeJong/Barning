<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="superuser.aspx.cs" Inherits="WebApplication.Views.index" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div style="height: 550px; border-color: #0033CC; background-color: #CCCCCC; width: 770px;">
            ...
            <asp:Button ID="Button2" runat="server" Style="top: 150px; left: 250px; position: absolute; height: 120px; width: 120px" Text="Historie" BackColor="#FFFF99" Font-Bold="True" />
            <asp:Button ID="Button3" runat="server" Style="top: 150px; left: 375px; position: absolute; height: 120px; width: 120px" Text="Verzonden SMS" BackColor="#FFFF99"  Font-Bold="True" />
            <asp:Button ID="Button4" runat="server" Style="top: 150px; left: 500px; position: absolute; height: 120px; width: 120px" Text="Controle" BackColor="#FFFF99" Font-Bold="True"  />
            ...
            <asp:Button ID="Button10" runat="server" Style="top: 400px; left: 250px; position: absolute; height: 120px; width: 120px" Text="Error log" BackColor="#FFFFCC" Font-Bold="True" OnClick="Button10_Click"  />
